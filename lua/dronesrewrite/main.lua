...
DRONES_REWRITE.SortedKeys = {"Forward", "Back", "Right", "Left", "Down", "Up", "Sprint", "MoveSlowly", "Exit", "ThirdPerson", "Enable", "Fire1", "Fire2", "SelfDestruct", "NightVision", "Flashlight", "SpecialKey", "WeaponView", "Zoom", "StrafeRight", "StrafeLeft"}
