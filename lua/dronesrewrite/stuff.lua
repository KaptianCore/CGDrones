...
if SERVER then
    ...
    surface.CreateFont("DronesRewrite_font1", {
        font = "Tahoma",
        size = 40,
        weight = 2000
    })

    surface.CreateFont("DronesRewrite_font2", {
        font = "Tahoma",
        size = 12,
        weight = 2000
    })

    surface.CreateFont("DronesRewrite_font3", {
        font = "Tahoma",
        size = 25,
        weight = 2000
    })

    surface.CreateFont("DronesRewrite_font4", {
        font = "Tahoma",
        size = 18,
        weight = 1
    })

    surface.CreateFont("DronesRewrite_font5", {
        font = "Lucida Console",
        size = 16,
        weight = 1
    })

    surface.CreateFont("DronesRewrite_font6", {
        font = "Impact",
        size = 18,
        weight = 1
    })

    surface.CreateFont("DronesRewrite_customfont1", {
        font = "Exo",
        size = 16,
        weight = 1
    })

    surface.CreateFont("DronesRewrite_customfont1_1", {
        font = "Exo",
        size = 25,
        weight = 1
    })

    surface.CreateFont("DronesRewrite_customfont2", {
        font = "Gnuolane RG",
        size = 25,
        weight = 1
    })

    surface.CreateFont("DronesRewrite_customfont2_1", {
        font = "Gnuolane RG",
        size = 28,
        weight = 1
    })

    surface.CreateFont("DronesRewrite_customfont1big", {
        font = "Exo",
        size = 100,
        weight = 1
    })

    surface.CreateFont("DronesRewrite_customfont1big2", {
        font = "Exo",
        size = 60,
        weight = 1
    })

    surface.CreateFont("DronesRewrite_font3_out", {
        font = "Tahoma",
        size = 30,
        weight = 1
    })
    ...
    hook.Add("PlayerBindPress", "dronesrewrite_stopmenu", function(ply, bind, p)
        ...
        if drone:IsValid() then
            local tools = {"phys_swap", "slot", "invnext", "invprev", "lastinv", "gmod_tool", "gmod_toolmode"}
...
local nocollide = {"dronesrewrite_bl_laser", "dronesrewrite_rd_laser", "dronesrewrite_rd_laser_sm", "dronesrewrite_gr_laser_sm", "dronesrewrite_missile", "dronesrewrite_rocket", "dronesrewrite_rocketbig"}
